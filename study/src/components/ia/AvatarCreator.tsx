  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/80 backdrop-blur-md p-4">
      <div className="ia-creator-modal w-full max-w-[900px] h-[90vh] sm:h-[80vh] flex flex-col rounded-3xl overflow-hidden">
        {/* Header */}
        <div className="ia-creator-header flex items-center justify-between p-5 border-b border-dark-800/50">
        ...
        <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
          {/* Preview panel */}
          <div className="p-6 md:w-[280px] bg-[#0a0f1a]/40 border-r border-gray-800/50 flex flex-col items-center flex-shrink-0">
            <div className="bg-gradient-to-b from-[#111827] to-[#0b0f19] border border-gray-700/50 rounded-2xl p-4 flex items-center justify-center h-[220px] w-full mb-4 relative group">
            ...
            <button
              onClick={randomize}
              className="w-full py-3 px-4 rounded-xl font-bold text-sky-300 border border-sky-500/30 bg-sky-500/5 hover:bg-sky-500/15 transition-all flex items-center justify-center gap-2"
            >
        ...
        {/* Footer */}
        <div className="border-t border-gray-800/50 p-5 flex justify-end gap-3 bg-[#050810]/80">
          <button onClick={onClose} className="px-5 py-2 rounded-xl text-gray-400 font-medium hover:text-white bg-gray-900 border border-gray-700 hover:border-gray-500 transition-all">
            Annuler
          </button>
          <button
            onClick={handleSave}
